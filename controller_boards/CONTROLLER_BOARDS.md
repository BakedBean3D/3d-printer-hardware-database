...
- **Notes:** Confidence high — Tier-1 (vendor CAD/drawing). 40 x 40, 31 x 31 four-hole pattern, 4x M3, 4.00 mm edge dim all annotated on official SIZE PDF + wiki. RESOLVED 2026-09-24 AGAINST THE VENDOR SOLID -- the drawing-only ambiguity previously recorded here is closed. BTT publishes a STEP in the same repo this record already cited; measured with OCCT (least-squares cylinder axes, NOT face extents), the PCB solid is exactly 40.000 x 40.000 and its four r=1.550 through-hole axes sit at (4.500, 4.500), (4.500, 35.500), (35.500, 4.500) and (35.500, 35.500) -- i.e. 4.5 mm from EVERY edge, confirming holes_xy exactly and settling the inset at 4.5. The SIZE drawing's printed "4.00 mm" is therefore NOT edge-to-centre; mount_inset_from_edge_mm was 4.0 and is corrected to 4.5. The retracted alternative reading in the old note ("holes at 4.0/35.0, span 32") was also self-inconsistent: 4.0/35.0 spans 31, not 32. Pitch 31.0 x 31.0 was correct throughout and is unaffected. Measured hole dia in the solid is 3.10; the recorded 3.2 is a clearance figure, left as-is and flagged here rather than silently changed. Mounting: clean 40 x 40 board, 4x M3 on a 31 x 31 square grid (a NEMA17-ish bolt grid). thickness assumed. Source: https://github.com/bigtreetech/EBB/blob/master/EBB%20CAN%20V1.1%20and%20V1.2%20(STM32G0B1)/EBB42%20CAN%20V1.1%20and%20V1.2/Hardware/BIGTREETECH%20EBB42%20CAN%20V1.1-SIZE.pdf
...
- src: https://github.com/bigtreetech/EBB/blob/master/EBB%20CAN%20V1.1%20and%20V1.2%20(STM32G0B1)/EBB42%20CAN%20V1.1%20and%20V1.2/3D/BIGTREETECH%20EBB42%20CAN%20V1.1.step
