...
Re-verified 2026-09-21: fresh web search still finds only V1.0/V1.1 (global.bttwiki.com/U2C.html) and V2.1 (github.com/bigtreetech/U2C/releases, maz0r.github.io/klipper_canbus/controller/u2c.html) in BTT's official channels and community docs - no V3 release, no GitHub tag, no retailer listing for a genuine hardware V3. Confirmed still unpublished; no fields changed, tier and DO-NOT-generate-geometry guidance stand.
- src: https://global.bttwiki.com/U2C.html
- src: https://github.com/bigtreetech/docs/blob/master/docs/U2C.md
